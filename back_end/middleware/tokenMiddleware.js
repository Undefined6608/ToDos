...
// 引入 返回值类型
const {resultType, AUTHORIZATION_ERROR} = require("../utils/response");
// 引入 Token 私钥
...
module.exports = async function (req, res, next) {
    // 指定要排除的路径
    const excludedPaths = ['/api/user/hello', '/api/user/phoneOccupy', '/api/user/register', '/api/user/phoneLogin'];
